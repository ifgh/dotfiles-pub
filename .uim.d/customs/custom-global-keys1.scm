(define generic-on-key '("zenkaku-hankaku" "<Shift><Control><Meta> "))
(define generic-on-key? (make-key-predicate '("zenkaku-hankaku" "<Shift><Control><Meta> ")))
(define generic-off-key '("zenkaku-hankaku" "<Shift><Control><Meta> "))
(define generic-off-key? (make-key-predicate '("zenkaku-hankaku" "<Shift><Control><Meta> ")))
