(define generic-on-key '("<Shift><Control><Alt>F12"))
(define generic-on-key? (make-key-predicate '("<Shift><Control><Alt>F12")))
(define generic-off-key '("<Shift><Control><Alt>F12"))
(define generic-off-key? (make-key-predicate '("<Shift><Control><Alt>F12")))
