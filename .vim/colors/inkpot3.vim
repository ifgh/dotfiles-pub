...
if has("gui_running")
    ...
    exec "hi Normal         cterm=NONE   ctermfg=" . <SID>X("78") . "   ctermbg=233"
    ...
    exec "hi LineNr         cterm=BOLD   ctermfg=245   ctermbg=234"
    ...
    exec "hi TabLine        cterm=NONE   ctermfg=" . <SID>X("8") . "   ctermbg=234"
    exec "hi TabLineSel     cterm=BOLD   ctermfg=" . <SID>X("7") . "   ctermbg=234"
