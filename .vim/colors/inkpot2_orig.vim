" Vim color file
" Name:       inkpot2.vim
" Maintainer: Ciaran McCreesh <ciaranm@gentoo.org>, edit by mich :-)
...
if has("gui_running")
    ...
    exec "hi Folded         cterm=BOLD   ctermfg=" . <SID>X("52") . "   ctermbg=233"
    ...
    exec "hi LineNr         cterm=BOLD   ctermfg=" . <SID>X("8") . "   ctermbg=233"
    exec "hi NonText        cterm=BOLD   ctermfg=" . <SID>X("38") . "   ctermbg=0"
    ...
    exec "hi TabLine        cterm=NONE   ctermfg=" . <SID>X("8") . "   ctermbg=233"
    exec "hi TabLineSel     cterm=BOLD   ctermfg=" . <SID>X("7") . "   ctermbg=235"
    exec "hi TabLineFill    cterm=NONE   ctermfg=" . <SID>X("78") . "   ctermbg=245"
