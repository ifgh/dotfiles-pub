...
hi  StatusLine      cterm=NONE  ctermfg=244  ctermbg=235
hi  StatusLineNC    cterm=NONE  ctermfg=237  ctermbg=233
hi  VertSplit       cterm=NONE  ctermfg=244  ctermbg=238
hi  WildMenu        cterm=BOLD  ctermfg=214  ctermbg=232

hi  Pmenu           cterm=NONE  ctermfg=239  ctermbg=233
hi  PmenuSbar       cterm=NONE  ctermbg=240
hi  PmenuThumb      cterm=NONE  ctermbg=178
...
hi  NonText         cterm=NONE  ctermfg=82   ctermbg=NONE
hi  SpecialKey      cterm=NONE  ctermfg=82   ctermbg=NONE
...
hi  Identifier      cterm=NONE  ctermfg=97   ctermbg=NONE
hi  Ignore          cterm=NONE  ctermfg=61   ctermbg=NONE
hi  Number          cterm=NONE  ctermfg=87   ctermbg=NONE
hi  PreProc         cterm=NONE  ctermfg=40   ctermbg=NONE
hi  Special         cterm=NONE  ctermfg=63   ctermbg=NONE
hi  Statement       cterm=NONE  ctermfg=33   ctermbg=NONE
hi  Todo            cterm=BOLD  ctermfg=237  ctermbg=63
hi  Type            cterm=NONE  ctermfg=97   ctermbg=NONE
hi  Underlined      cterm=BOLD  ctermfg=229  ctermbg=NONE
hi  TaglistTagName  cterm=BOLD  ctermfg=33   ctermbg=NONE

hi  ColorColumn     ctermbg=233

hi  diffRemoved     cterm=BOLD  ctermfg=196
hi  diffAdded       cterm=BOLD  ctermfg=46
hi  diffFile        cterm=BOLD  ctermfg=226
hi  diffSubname     cterm=NONE  ctermfg=13
hi  diffLine        cterm=BOLD  ctermfg=13
