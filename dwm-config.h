...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_r,      spawn,          SHCMD("xterm -name xterm-tac-jabbersupport -e jabber --flavour support") },
	{ MODKEY|ShiftMask,             XK_t,      spawn,          SHCMD("xterm -name xterm-tac-jabberhipchat -e jabber --flavour hipchat") },
