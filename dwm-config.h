...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_r,      spawn,          SHCMD("xterm -name xterm-jabbersupport -e jabber --flavour support") },
	{ MODKEY|ShiftMask,             XK_t,      spawn,          SHCMD("xterm -name xterm-jabberhipchat -e jabber --flavour hipchat") },
