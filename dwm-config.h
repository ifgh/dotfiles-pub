...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_o,      spawn,          SHCMD("xterm -hold -e smail") },
	{ MODKEY|ShiftMask,             XK_i,      spawn,          SHCMD("xterm -hold -name xterm-tac-irc -e irc") },
	{ MODKEY|ShiftMask,             XK_z,      spawn,          SHCMD("xterm -name xterm-tac-jabber -e jabber") },
	{ MODKEY|ShiftMask,             XK_r,      spawn,          SHCMD("xterm -name xterm-tac-jabber-support -e jabber --flavour support") },
	{ MODKEY|ShiftMask,             XK_t,      spawn,          SHCMD("xterm -name xterm-tac-jabber-hipchat -e jabber --flavour hipchat") },
